...
const SubjectiveInformation: React.FC<Props> = () => {
  const [activeTab, setActiveTab] = useState<string | undefined>('description');
  const handleActiveTab = (tab: string) => {
    setActiveTab(tab);
  };
  return (
    <section className="desc-tab pb-10 md:pb-20">
              ...
              <div className="right">
                ...
                <div className="list-feature">
                  ...
                  <div className="item mt-1 flex gap-1 text-secondary">
                    <Icon.Dot size={28} />
                    <p>
                      Maecenas ullamcorper erat mi, vel consequat enim suscipit
                      at.
                    </p>
                  </div>
                  <div className="item mt-1 flex gap-1 text-secondary">
          ...
          >
            <div className="w-full sm:w-3/4 lg:w-1/2">
              ...
              <div className="item flex items-center gap-8 px-10 py-3">
                <div className="text-title w-1/3 sm:w-1/4">Fabric</div>
                <p>100% Cotton, Supima</p>
              </div>
              <div className="item flex items-center gap-8 bg-surface px-10 py-3">
                <div className="text-title w-1/3 sm:w-1/4">Organic</div>
                <p>100% Organic</p>
              </div>
              <div className="item flex items-center gap-8 px-10 py-3">
                <div className="text-title w-1/3 sm:w-1/4">Lint</div>
                <p>Bio Washed</p>
              </div>
              <div className="item flex items-center gap-8 bg-surface px-10 py-3">
                <div className="text-title w-1/3 sm:w-1/4">Vegan</div>
                <p>Yes</p>
              </div>
              <div className="item flex items-center gap-8 px-10 py-3">
